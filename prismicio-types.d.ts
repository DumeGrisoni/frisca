...
/**
 * Default variation for BigTextSmile Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type BigTextSmileSliceDefault = prismic.SharedSliceVariation<
  "default",
  Record<string, never>,
  never
>;
...
/**
 * Slice variation for *BigTextSmile*
 */
type BigTextSmileSliceVariation = BigTextSmileSliceDefault;

/**
 * BigTextSmile Shared Slice
 *
 * - **API ID**: `big_text_smile`
 * - **Description**: BigTextSmile
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type BigTextSmileSlice = prismic.SharedSlice<
  "big_text_smile",
  BigTextSmileSliceVariation
>;
